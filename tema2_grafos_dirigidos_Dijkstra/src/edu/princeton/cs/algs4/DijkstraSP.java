...
public class DijkstraSP {
    ...
    /** Output of the state in the Algorithm Dijkstra (aam) 
     */
    private void outputDijkstraState() {
       	System.out.println("------------------------------"); // aam
    	System.out.println(pq.toString());                    // aam
        System.out.println(distToToString());                 // aam
        System.out.println(edgeToToString());                 // aam
    }
    
    /** Output of the edgeTo array (aam) 
     */
    
    private String edgeToToString() {
    	String str = "edgeTo:";
    	for (int i = 0; i < edgeTo.length; i++) {
    		str = str + "[" + i + "]";
    		if (edgeTo[i] != null) {
    			str = str + " " + edgeTo[i].toString() + ", ";    			
    		} else {
    			str = str + " **, ";
    		}
		}
    ...
    /** Output of the distTo array (aam) 
     */
    
    private String distToToString() {
    	String str = "distTo: ";
