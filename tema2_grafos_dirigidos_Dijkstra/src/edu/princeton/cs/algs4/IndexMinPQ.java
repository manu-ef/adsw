...
import java.text.DecimalFormat; // aam
...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    ***************************************************************************/
	...
	/**
	 * Support for printing the edges in MinPQ (aam).
	 *
	 * @return The string with the edges
	 */

	public String toString() {

		String str = "Priority Queue: ";
		DecimalFormat formatKey = new DecimalFormat("0.00");
		
        for (int j = 0; j < keys.length; j++) {
			if (keys[j] != null) {
				str = str + "(" + pq[qp[j]] +  " " + formatKey.format(keys[j]) + ") ";
			}
		}
